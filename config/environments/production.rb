ActorsUniversity::Application.configure do
  #TECHDEBT - work out how to specify per app/deployment etc
  config.action_mailer.default_url_options = { :host => 'actors-university.herokuapp.com' }
  ...
  # http://stackoverflow.com/questions/17016168/heroku-rails-4-ruby-2-0-0-deploy-fail-production-database-is-not-connectable
